...
class Map(genpy.Message):
  _md5sum = "25aec8c3b4e4b0770fd225aa38b3bfb1"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.Keyframes:
        ...
        length = len(val1.mPointCloud)
        buff.write(_struct_I.pack(length))
        for val2 in val1.mPointCloud:
          _x = val2
          buff.write(_get_struct_3d3B().pack(_x.mDepth, _x.mx, _x.my, _x.mblue, _x.mgreen, _x.mred))
        length = len(val1.mright)
        buff.write(_struct_I.pack(length))
        for val2 in val1.mright:
          _x = val2.mvuRight
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.mPointCloud = []
        for i in range(0, length):
          val2 = ccmslam_msgs.msg.PC()
          _x = val2
          start = end
          end += 27
          (_x.mDepth, _x.mx, _x.my, _x.mblue, _x.mgreen, _x.mred,) = _get_struct_3d3B().unpack(str[start:end])
          val1.mPointCloud.append(val2)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.mright = []
        for i in range(0, length):
          val2 = ccmslam_msgs.msg.right()
          start = end
          end += 4
          (val2.mvuRight,) = _get_struct_f().unpack(str[start:end])
          val1.mright.append(val2)
        start = end
        end += 64
