...
#include <ccmslam_msgs/PC.h>
#include <ccmslam_msgs/right.h>
...
struct KF_
{
  ...
  _invfy_type invfy;
   ...
   typedef float _mbf_type;
  _mbf_type mbf;

   typedef float _mb_type;
  _mb_type mb;
  ...
  _mDescriptors_type mDescriptors;
   ...
   typedef std::vector< ::ccmslam_msgs::PC_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ccmslam_msgs::PC_<ContainerAllocator> >> _mPointCloud_type;
  _mPointCloud_type mPointCloud;

   typedef std::vector< ::ccmslam_msgs::right_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ccmslam_msgs::right_<ContainerAllocator> >> _mright_type;
  _mright_type mright;
...
bool operator==(const ::ccmslam_msgs::KF_<ContainerAllocator1> & lhs, const ::ccmslam_msgs::KF_<ContainerAllocator2> & rhs)
{
  return lhs.bSentOnce == rhs.bSentOnce &&
    ...
    lhs.mPointCloud == rhs.mPointCloud &&
    lhs.mright == rhs.mright &&
...
struct MD5Sum< ::ccmslam_msgs::KF_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xa6c3197f3c165f89ULL;
  static const uint64_t static_value2 = 0xcfb6d964597ca46cULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ccmslam_msgs::KF_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.mPointCloud);
      stream.next(m.mright);
...
struct Printer< ::ccmslam_msgs::KF_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ccmslam_msgs::KF_<ContainerAllocator>& v)
  {
    ...
    s << indent << "mbf: ";
    Printer<float>::stream(s, indent + "  ", v.mbf);
    s << indent << "mb: ";
    Printer<float>::stream(s, indent + "  ", v.mb);
    s << indent << "N: ";
    ...
    s << indent << "mPointCloud[]" << std::endl;
    for (size_t i = 0; i < v.mPointCloud.size(); ++i)
    {
      s << indent << "  mPointCloud[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::ccmslam_msgs::PC_<ContainerAllocator> >::stream(s, indent + "    ", v.mPointCloud[i]);
    }
    s << indent << "mright[]" << std::endl;
    for (size_t i = 0; i < v.mright.size(); ++i)
    {
      s << indent << "  mright[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::ccmslam_msgs::right_<ContainerAllocator> >::stream(s, indent + "    ", v.mright[i]);
    }
