...
class KF {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('mbf')) {
        this.mbf = initObj.mbf
      }
      else {
        this.mbf = 0.0;
      }
      if (initObj.hasOwnProperty('mb')) {
        this.mb = initObj.mb
      }
      else {
        this.mb = 0.0;
      ...
      if (initObj.hasOwnProperty('mPointCloud')) {
        this.mPointCloud = initObj.mPointCloud
      }
      else {
        this.mPointCloud = [];
      }
      if (initObj.hasOwnProperty('mright')) {
        this.mright = initObj.mright
      }
      else {
        this.mright = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [mbf]
    bufferOffset = _serializer.float32(obj.mbf, buffer, bufferOffset);
    // Serialize message field [mb]
    bufferOffset = _serializer.float32(obj.mb, buffer, bufferOffset);
    ...
    // Serialize message field [mPointCloud]
    // Serialize the length for message field [mPointCloud]
    bufferOffset = _serializer.uint32(obj.mPointCloud.length, buffer, bufferOffset);
    obj.mPointCloud.forEach((val) => {
      bufferOffset = PC.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [mright]
    // Serialize the length for message field [mright]
    bufferOffset = _serializer.uint32(obj.mright.length, buffer, bufferOffset);
    obj.mright.forEach((val) => {
      bufferOffset = right.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [mbf]
    data.mbf = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [mb]
    data.mb = _deserializer.float32(buffer, bufferOffset);
    ...
    // Deserialize message field [mPointCloud]
    // Deserialize array length for message field [mPointCloud]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.mPointCloud = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.mPointCloud[i] = PC.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [mright]
    // Deserialize array length for message field [mright]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.mright = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.mright[i] = right.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    ...
    length += 27 * object.mPointCloud.length;
    length += 4 * object.mright.length;
  ...
  static md5sum() {
    ...
    return 'a6c3197f3c165f89cfb6d964597ca46c';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.mbf !== undefined) {
      resolved.mbf = msg.mbf;
    }
    else {
      resolved.mbf = 0.0
    }
    ...
    if (msg.mPointCloud !== undefined) {
      resolved.mPointCloud = new Array(msg.mPointCloud.length);
      for (let i = 0; i < resolved.mPointCloud.length; ++i) {
        resolved.mPointCloud[i] = PC.Resolve(msg.mPointCloud[i]);
      }
    }
    else {
      resolved.mPointCloud = []
    }

    if (msg.mright !== undefined) {
      resolved.mright = new Array(msg.mright.length);
      for (let i = 0; i < resolved.mright.length; ++i) {
        resolved.mright[i] = right.Resolve(msg.mright[i]);
      }
    }
    else {
      resolved.mright = []
