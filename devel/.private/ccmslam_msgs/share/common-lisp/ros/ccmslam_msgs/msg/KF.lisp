...
(cl:defclass <KF> (roslisp-msg-protocol:ros-message)
  ((bSentOnce
   ...
   (mPointCloud
    :reader mPointCloud
    :initarg :mPointCloud
    :type (cl:vector ccmslam_msgs-msg:PC)
   :initform (cl:make-array 0 :element-type 'ccmslam_msgs-msg:PC :initial-element (cl:make-instance 'ccmslam_msgs-msg:PC)))
   (mright
    :reader mright
    :initarg :mright
    :type (cl:vector ccmslam_msgs-msg:right)
   :initform (cl:make-array 0 :element-type 'ccmslam_msgs-msg:right :initial-element (cl:make-instance 'ccmslam_msgs-msg:right)))
   (mTcpred
    :reader mTcpred
    :initarg :mTcpred
...
(cl:ensure-generic-function 'mbf-val :lambda-list '(m))
(cl:defmethod mbf-val ((m <KF>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ccmslam_msgs-msg:mbf-val is deprecated.  Use ccmslam_msgs-msg:mbf instead.")
  (mbf m))

(cl:ensure-generic-function 'mb-val :lambda-list '(m))
(cl:defmethod mb-val ((m <KF>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ccmslam_msgs-msg:mb-val is deprecated.  Use ccmslam_msgs-msg:mb instead.")
  (mb m))
...
(cl:ensure-generic-function 'mPointCloud-val :lambda-list '(m))
(cl:defmethod mPointCloud-val ((m <KF>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ccmslam_msgs-msg:mPointCloud-val is deprecated.  Use ccmslam_msgs-msg:mPointCloud instead.")
  (mPointCloud m))

(cl:ensure-generic-function 'mright-val :lambda-list '(m))
(cl:defmethod mright-val ((m <KF>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ccmslam_msgs-msg:mright-val is deprecated.  Use ccmslam_msgs-msg:mright instead.")
  (mright m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <KF>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'invfy))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'mbf))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'mb))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'mPointCloud))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'mPointCloud))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'mright))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'mright))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <KF>) istream)
  "Deserializes a message object of type '<KF>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'mbf) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'mb) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'mPointCloud) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'mPointCloud)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ccmslam_msgs-msg:PC))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'mright) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'mright)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ccmslam_msgs-msg:right))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<KF>)))
  ...
  "a6c3197f3c165f89cfb6d964597ca46c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'KF)))
  "Returns md5sum for a message object of type 'KF"
  "a6c3197f3c165f89cfb6d964597ca46c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<KF>)))
  "Returns full string definition for message of type '<KF>"
  (cl:format cl:nil "bool bSentOnce~%~%uint16 mnId # unique KF id~%uint8 mClientId # client id~%uint32 mUniqueId~%float64 dTimestamp~%bool mbAck~%~%#Grid (to speed up feature matching)~%    int16 mnGridCols~%    int16 mnGridRows~%    float32 mfGridElementWidthInv~%    float32 mfGridElementHeightInv~%~%#Calibration parameters~%    float32 fx~%    float32 fy~%    float32 cx~%    float32 cy~%    float32 invfx~%    float32 invfy~%     float32 mbf~%    float32 mb~%~%#Number of KeyPoints~%    int16 N~%~%#KeyPoints, stereo coordinate and descriptors (all associated by an index)~%    CvKeyPoint[] mvKeysUn~%    Descriptor[] mDescriptors~%    PC[] mPointCloud~%    right[] mright~%~%#Pose relative to parent~%    float32[16] mTcpred~%    float32[16] mTcpar~%~%    bool mbPoseChanged~%~%    bool mbServerBA~%~%    float32[16] mT_SC~%~%#Scale~%    int8 mnScaleLevels~%    float32 mfScaleFactor~%    float32 mfLogScaleFactor~%    float32[8] mvScaleFactors~%    float32[8] mvLevelSigma2~%    float32[8] mvInvLevelSigma2~%~%#Image bounds and calibration~%    int16 mnMinX~%    int16 mnMinY~%    int16 mnMaxX~%    int16 mnMaxY~%    float32[9] mK~%~%#MapPoints associated to keypoints~%    uint32[] mvpMapPoints_Ids~%    uint8[] mvpMapPoints_ClientIds~%    uint16[] mvpMapPoints_VectId~%~%#Related KFs~%    uint16 mpPred_KfId~%    uint8 mpPred_KfClientId~%    uint16 mpPar_KfId~%    uint8 mpPar_KfClientId~%~%#Bad flags~%    bool mbBad~%~%================================================================================~%MSG: ccmslam_msgs/CvKeyPoint~%float32 fPoint2f_x~%float32 fPoint2f_y~%#float32 size~%uint8 size~%float32 angle~%#float32 response~%uint8 response~%int8 octave~%#int8 class_id~%~%================================================================================~%MSG: ccmslam_msgs/Descriptor~%uint8[32] mDescriptor~%~%================================================================================~%MSG: ccmslam_msgs/PC~%float64 mDepth~%float64 mx~%float64 my~%uint8 mblue~%uint8 mgreen~%uint8 mred~%================================================================================~%MSG: ccmslam_msgs/right~%float32 mvuRight~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'KF)))
  "Returns full string definition for message of type 'KF"
  (cl:format cl:nil "bool bSentOnce~%~%uint16 mnId # unique KF id~%uint8 mClientId # client id~%uint32 mUniqueId~%float64 dTimestamp~%bool mbAck~%~%#Grid (to speed up feature matching)~%    int16 mnGridCols~%    int16 mnGridRows~%    float32 mfGridElementWidthInv~%    float32 mfGridElementHeightInv~%~%#Calibration parameters~%    float32 fx~%    float32 fy~%    float32 cx~%    float32 cy~%    float32 invfx~%    float32 invfy~%     float32 mbf~%    float32 mb~%~%#Number of KeyPoints~%    int16 N~%~%#KeyPoints, stereo coordinate and descriptors (all associated by an index)~%    CvKeyPoint[] mvKeysUn~%    Descriptor[] mDescriptors~%    PC[] mPointCloud~%    right[] mright~%~%#Pose relative to parent~%    float32[16] mTcpred~%    float32[16] mTcpar~%~%    bool mbPoseChanged~%~%    bool mbServerBA~%~%    float32[16] mT_SC~%~%#Scale~%    int8 mnScaleLevels~%    float32 mfScaleFactor~%    float32 mfLogScaleFactor~%    float32[8] mvScaleFactors~%    float32[8] mvLevelSigma2~%    float32[8] mvInvLevelSigma2~%~%#Image bounds and calibration~%    int16 mnMinX~%    int16 mnMinY~%    int16 mnMaxX~%    int16 mnMaxY~%    float32[9] mK~%~%#MapPoints associated to keypoints~%    uint32[] mvpMapPoints_Ids~%    uint8[] mvpMapPoints_ClientIds~%    uint16[] mvpMapPoints_VectId~%~%#Related KFs~%    uint16 mpPred_KfId~%    uint8 mpPred_KfClientId~%    uint16 mpPar_KfId~%    uint8 mpPar_KfClientId~%~%#Bad flags~%    bool mbBad~%~%================================================================================~%MSG: ccmslam_msgs/CvKeyPoint~%float32 fPoint2f_x~%float32 fPoint2f_y~%#float32 size~%uint8 size~%float32 angle~%#float32 response~%uint8 response~%int8 octave~%#int8 class_id~%~%================================================================================~%MSG: ccmslam_msgs/Descriptor~%uint8[32] mDescriptor~%~%================================================================================~%MSG: ccmslam_msgs/PC~%float64 mDepth~%float64 mx~%float64 my~%uint8 mblue~%uint8 mgreen~%uint8 mred~%================================================================================~%MSG: ccmslam_msgs/right~%float32 mvuRight~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <KF>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'mPointCloud) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'mright) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <KF>))
  ...
  (cl:list 'KF
    ...
    (cl:cons ':mPointCloud (mPointCloud msg))
    (cl:cons ':mright (mright msg))
