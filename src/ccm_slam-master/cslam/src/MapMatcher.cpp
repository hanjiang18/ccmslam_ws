...
MapMatcher::MapMatcher(ros::NodeHandle Nh, ros::NodeHandle NhPrivate, dbptr pDB, vocptr pVoc, mapptr pMap0, mapptr pMap1, mapptr pMap2, mapptr pMap3,pcmptr pPointCloud)
...
void MapMatcher::Run()
{
    ...
    mpMapMerger.reset(new MapMerger(shared_from_this(),mpPointCloudMapping));
